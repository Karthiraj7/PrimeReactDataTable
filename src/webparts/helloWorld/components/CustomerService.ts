interface Country {
  ...
  export const CustomerService = {
    ...
    getCustomersSmall(): Promise<CustomerData[]> {
        return Promise.resolve(this.getData().slice(0, 10));
    },
  
    getCustomersMedium(): Promise<CustomerData[]> {
        return Promise.resolve(this.getData().slice(0, 50));
    },
  
    getCustomersLarge(): Promise<CustomerData[]> {
        return Promise.resolve(this.getData().slice(0, 200));
    },
  
    getCustomersXLarge(): Promise<CustomerData[]> {
        return Promise.resolve(this.getData());
    },
  
    getCustomers(params?: Record<string, any>): Promise<CustomerData[]> {
